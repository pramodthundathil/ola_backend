    ...
    def aggregate_fpd_analytics(self, date, force=False):
        ...
        for store in stores:
            ...
            for contract in contracts_60:
                ...
                if paid_count < 2:  # Less than 40% of 5 payments
                    early_inactive += 1
            
            early_inactive_rate = (early_inactive / contracts_60.count() * 100) if contracts_60.exists() else 0
